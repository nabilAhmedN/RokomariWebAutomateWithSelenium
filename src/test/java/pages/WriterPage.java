...
//            }
//        } catch (Exception e) {
//            test.fail("<p style=\"color:red; font-size:13px\"><b>First Book not locatable</b></p>");
//            Throwable t = new InterruptedException("Exception");
//            test.fail(t);
//            @SuppressWarnings("unused")
...
//            test.fail(MediaEntityBuilder.createScreenCaptureFromPath(dest).build());
//            junit.framework.Assert.assertTrue(FirstBookToCart.isDisplayed());
//            PageDriver.getCurrentDriver().quit();
//        }
//        timeOut(2000);
//    }
...
//            }
//        } catch (Exception e) {
//            test.fail("<p style=\"color:red; font-size:13px\"><b>Second Book Hovering not locatable</b></p>");
//            Throwable t = new InterruptedException("Exception");
//            test.fail(t);
//            @SuppressWarnings("unused")
...
//            test.fail(MediaEntityBuilder.createScreenCaptureFromPath(dest).build());
//            junit.framework.Assert.assertTrue(SecondBookHover.isDisplayed());
//            PageDriver.getCurrentDriver().quit();
//        }
//    }
//
//    public void SecondBookInAddToCart() throws IOException{
//        test.info("Ordering Second Book");
//        try {
//            if (SecondBookToCart.isDisplayed()) {
//                SecondBookToCart.click();
//                test.pass("<p style=\"color:green; font-size:13px\"><b>Order Second Book Success</b></p>");
//
//                @SuppressWarnings("unused")
//                String screenShotPath = GetScreenShot.capture(PageDriver.getCurrentDriver(),
//                        "SecondBookOrderPass");
...
//            }
//        } catch (Exception e) {
//            test.fail("<p style=\"color:red; font-size:13px\"><b>Second Book not locatable</b></p>");
//            Throwable t = new InterruptedException("Exception");
//            test.fail(t);
//            @SuppressWarnings("unused")
...
//            test.fail(MediaEntityBuilder.createScreenCaptureFromPath(dest).build());
//            junit.framework.Assert.assertTrue(SecondBookToCart.isDisplayed());
//            PageDriver.getCurrentDriver().quit();
//        }
//    }
//
